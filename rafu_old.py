...
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWARNING  : Fuck My All Hater
\033[1;90m══════════════════════════════════════════════════
    """)
		...
		print("%s [%s8%s]%s CRACK RANDOM FB ID 2003-4 %s(ULTA PRO) V4"%(R,G,R,Y,G))
	...
	def old4_7(self):
		...
		limit = int(input("\033[0;92m [+] ENTER LIMIT \033[0;91m(10,000 MAX): \033[0;92m"))
		if (limit)>10000:
			exit("\n%s [!] DON'T CROSS THE LIMIT BRO :)"%(R))
		try:
			for n in range(limit):
